...
class MUSICAlgorithm(Algorithm):
    ...
    def __init__(self,
        ...
        Args:
            ...
            sos_spec (tf.TensorSpec): state of surrounding size
            soa_spec (tf.TensorSpec): state of agent size
            split_observation_fn (Callable): split observation function.
                The input is observation and action concatenated.
                The outputs are the agent states and surrounding states
    ...
    def train_step(self,
        ...
        Args:
            ...
            state (tuple): state for MUSIC (previous observation,
